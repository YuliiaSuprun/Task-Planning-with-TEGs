...
public:
    ...
    const vector<GridAction>& get_actions(const DomainState& state) const override;
    ...
    const vector<pair<shared_ptr<DomainState>, GridAction>> get_successor_state_action_pairs(const DomainState& curr_state) override;
